(function (doc, win) {
  ...
  var docEl = doc.documentElement // 将html元素获取
  var resizeEvt = 'orientationchange' in window ? 'orientationchange' : 'resize' // 获取resize事件，如果是在移动端，就使用orientationchange屏幕方向改变时间 ，如果在pc端，使用resize方便开发者进行测试
  var recalc = function () {
